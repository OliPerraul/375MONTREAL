...
public class RoundsController : MonoBehaviour
{
	...
	public AudioClip glam;
	public AudioClip hipHop;
	public AudioClip hippie;
	public AudioClip indiens;
	public AudioClip industrialisation;
	public AudioClip pinup;
	public AudioClip prohibition;
    ...
    void Start ()
    {
		...
		audioControl = audio;
		MusicController music = (MusicController)FindObjectOfType (typeof(MusicController));
		musicControl = music;
	...
	void Update ()
	{switch (announced_job){
		case "industrialisation":
			musicControl.PlayClip (6);
			Debug.Log ("Playing industrialisation");
			break;
		case "prohibition":
			musicControl.PlayClip (8);
			Debug.Log("Playing Prohibition");
			break;
		case "pinUp":
			musicControl.PlayClip (7);
			Debug.Log("Playing PinUp");
			break;
		case "hippie":
			musicControl.PlayClip (4);
			Debug.Log("Playing Hippie");
			break;
		case "disco":
			musicControl.PlayClip (1);
			Debug.Log("Playing disco");
			break;
		case "glam":
			musicControl.PlayClip (2);
			Debug.Log("Playing glam");
			break;
		case "hipHop":
			musicControl.PlayClip (3);
			Debug.Log("Playing hipHop");
			break;
		case "coureurdesbois":
			musicControl.PlayClip (5);
			Debug.Log("Playing indiens");
			break;
		}
	...
	public void PlayLoop(AudioClip clip2){
		BGM.Stop ();
		BGM.clip = clip2;
		BGM.Play ();
		BGM.loop = true;
	}
	public void PlayStop(AudioClip clip){
		BGM.clip = clip;
		BGM.Stop ();
	}
